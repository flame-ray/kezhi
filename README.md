...
课织是一个面向 Windows 10/11 与 Android 的本地优先大学课表应用。当前 0.3.2 版本包含周课表、按学号识别年级的校历建议、可分别调整的第 1 周周一与正式上课日、课程详情、轻量化 GPU 跟手周翻页、低误触长按新增课程、Material 风格竖屏界面、亮暗主题、拖放调整、多套作息、系统课程提醒、SQLite 本地持久化，以及宁德师范学院正方教务系统的原生登录与课表读取适配器。
